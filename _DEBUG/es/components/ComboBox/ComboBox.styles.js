...
export const getOptionStyles = memoizeFunction((theme, customStylesForAllOptions, customOptionStylesForCurrentOption, isPending) => {
...
export const getCaretDownButtonStyles = memoizeFunction((theme, customStyles) => {
    const { semanticColors } = theme;
...
export const getStyles = memoizeFunction((theme, customStyles, comboBoxOptionWidth) => {
