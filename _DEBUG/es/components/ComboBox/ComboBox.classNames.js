...
export const getClassNames = memoizeFunction((styles, className, isOpen, disabled, required, focused, allowFreeForm, hasErrorMessage) => {
    return {
...
export const getComboBoxOptionClassNames = memoizeFunction((styles) => {
    return {
